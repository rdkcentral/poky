...
python native_virtclass_handler () {
    ...
    def map_dependencies(varname, d, suffix, selfref=True, regex=False):
        ...
        if d.getVar(varname, False):
            d.setVarFlag(varname, "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
    ...
    d.setVarFlag("DEPENDS", "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "', selfref=False)")
    ...
    d.setVarFlag("PACKAGES", "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
    d.setVarFlag("PACKAGES_DYNAMIC", "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "', regex=True)")
